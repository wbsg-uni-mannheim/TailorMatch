...
# This script is designed to process multiple datasets and generate text embeddings using OpenAI’s embedding model. It loads product matching datasets, computes embeddings for each pair of product titles, and saves the results for further analysis.
...
datasets = [
    {"dataset_name": "amazon-google-train",
        "dataset_path": "../data/amazon-google/amazon-google-train.json"},
    {"dataset_name": "dblp-acm",
        "dataset_path": "../data/dblp-acm/dblp-acm-train.json.gz"},
    {"dataset_name": "dblp-scholar",
        "dataset_path": "../data/dblp-scholar/dblp-scholar-train.json.gz"},
    {"dataset_name": "walmart-amazon",
        "dataset_path": "../data/walmart-amazon/walmart-amazon-train.json.gz"}
]
